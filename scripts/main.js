...
async function getTotalSupply() {
  ...
  async function mint() {
    ...
    var _amount = amount[found]
    var claimingAddress = leafNodes[found];
    const hexProof = merkleTree.getHexProof(claimingAddress);

      const options = {
          contractAddress: "0x81E3eC24f1b0E451a0aF6110211B209eE76C9E54",
          functionName: "mint",
          abi: ABI,
          params: {
            _to: walletAddress,
